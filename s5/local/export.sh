...
final_graph_dir=/opt/kaldi/zeroth/s5/exp/chain_rvb/tree_a_ebs_v2/graph_tgsmall
final_model_dir=/opt/kaldi/zeroth/s5/exp/chain_rvb/tdnn1n_rvb_online
small_lm=/opt/kaldi/zeroth/s5/data/lang_nosp_test_tgsmall_v2/G.fst
large_lm=/opt/kaldi/zeroth/s5/data/lang_nosp_test_fglarge_v2/G.carpa

dir=$1/test/models/korean/ebs_model_v2
mkdir -p $dir

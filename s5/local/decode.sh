...
echo "#### Decoding ####"
result=`$decoder $silence_weighting_opts --do-endpointing=$do_endpointing \
...
echo $result
echo "python execute"
#python3 ./local/spacing.py $result
...
if $rescore ; then
	...
	result=`lattice-copy "ark:gunzip -c $dir/lmre_lat.1.gz|" ark:- |\
